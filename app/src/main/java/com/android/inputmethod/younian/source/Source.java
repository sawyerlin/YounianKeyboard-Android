...
public final class Source {
    private static Hashtable<SourceType, Hashtable<String, String>> source = new Hashtable<SourceType, Hashtable<String, String>>();

    static {
        Hashtable <String, String> latinSource = new Hashtable<String, String>();
        Hashtable <String, String> arabicSource = new Hashtable<String, String>();
