 ...
 * Original file: /home/slin/AndroidStudioProjects/PinyinIME1/app/src/main/aidl/com/android/inputmethod/younian/IPinyinDecoderService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.android.inputmethod.younian.IPinyinDecoderService
{
private static final java.lang.String DESCRIPTOR = "com.android.inputmethod.younian.IPinyinDecoderService";
...
/**
 * Cast an IBinder object into an com.android.inputmethod.younian.IPinyinDecoderService interface,
 * generating a proxy if needed.
 */
public static com.android.inputmethod.younian.IPinyinDecoderService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.inputmethod.younian.IPinyinDecoderService))) {
return ((com.android.inputmethod.younian.IPinyinDecoderService)iin);
}
return new com.android.inputmethod.younian.IPinyinDecoderService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.android.inputmethod.younian.IPinyinDecoderService
{
...
static final int TRANSACTION_imResetSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_imDelSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_imSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_imChoose = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_imGetSplStart = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_imGetPyStr = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_imGetPyStrLen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_imGetFixedLen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_imGetChoiceList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_imGetPredictList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_imAddLetter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_imCancelLastChoice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_imCancelInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_imFlushCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_imGetPredictsNum = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
