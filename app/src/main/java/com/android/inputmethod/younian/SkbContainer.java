...
public class SkbContainer extends RelativeLayout implements OnTouchListener {
    ...
    public SkbContainer(Context context, AttributeSet attrs) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        super(context, attrs);
        ...
        if ("1".equals(Class.forName("android.os.SystemProperties").getMethod("get", String.class).invoke(null, "ro.kernel.qemu"))) {
            mYBiasCorrection = 0;
        } else {
